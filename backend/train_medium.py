...
def setup_data(data_dir, output_dir="data_split_medium"):
    ...
    train_ratio = 0.85
    max_images_per_class = 600 # Medium subset for good accuracy in reasonable time
...
def train_model(train_root, val_root):
    ...
    num_workers = 0 # FORCED NO MULTIPROCESSING to prevent Windows freezes
