...
def setup_data(data_dir, output_dir="data_split_fast"):
    ...
    train_ratio = 0.85
    max_images_per_class = 50 # For fast training
...
def train_model(train_root, val_root):
    ...
    torch.save(model.state_dict(), "models/resnet18_math_symbols_v2.pth")
    print("Saved model weights to models/resnet18_math_symbols_v2.pth")
