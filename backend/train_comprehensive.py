...
def setup_data(data_dir, output_dir="data_split_full"):
    ...
    for cls in classes:
        ...
        # We have ~370k images. 85% train, 15% val.
        n = len(images)
        ...
        print(f"Processing class {cls}: {n} images")
...
def train_model(train_root, val_root):
    ...
    # Simplified transforms for faster training on large dataset
    ...
    num_workers = 0 # Prevent Windows hanging
    ...
    # Fine-tune the whole model since we have enough data
    ...
    num_epochs = 1 # 1 epoch based on high 96% acc validation
